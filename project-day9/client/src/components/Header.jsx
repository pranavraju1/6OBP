  ...
  return (
    <div className='mx-8 sm:mx-16 xs:mx-24 relative'>
        <div className='text-center mt-20 mb-8'>
            ...
            <form onSubmit={onsubmitHandler} className='flex justify-between max-w-lg max-sm:scale-75 mx-auto border border-gray-300 
                bg-white rouded overflow-hidden
            '>
                <input ref={inputRef} type="text" placeholder='Search for blogs' required className='w-full pl-4 
                    outline-none
                ' />
        ...
        <div className='text-center'>
            {input && <button className='border font-light text-xs py-1 px-3 rounded-sm shadow-custom-sm 
                cursor-pointer
            '>Clear Search</button>}
        </div>
